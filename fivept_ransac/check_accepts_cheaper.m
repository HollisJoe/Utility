function [est_a, est_b, est_c]=check_accepts_cheaper(data, ind1, ind2, ind3, accept_binary)
...
[pose_est_a, sm_a, cams_a]= compute_triplet_rot(data, pair1, pair2);
...
[pose_est_b, sm_b, cams_b]= compute_triplet_rot(data, pair1, pair2);
...
[pose_est_c, sm_c, cams_c]= compute_triplet_rot(data, pair1, pair2);
