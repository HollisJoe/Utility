function [index_final,all_matches, x1, x2, m_e, pose]=asift_pose(path_all,  ind1,   ind2, K1, K2)
...
%heat_mapped_matches(image1, image2, K1*cat(1, x1,ones(1, size(x1,2))), K2*cat(1, x2,ones(1, size(x2,2))), 'a.png','b.png');
