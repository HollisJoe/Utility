function [matchings, xy1, xy2, image1, image2]=display_epipolar_bf(path_all, i, j, K1, K2)
...
heat_mapped_matches(image1, image2, xy1(1:2,matchings(1,:)), xy2(1:2,matchings(2,:)));
