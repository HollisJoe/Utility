...
% K1(1:2,:)= (960/3072)*K1(1:2,:);
% K2(1:2,:)= (960/3072)*K2(1:2,:);
...
K1=[2900.120764843560200 0 791.168475644626030
    ...
    0 0 1];
K2=[2900.120764843560200 0 791.168475644626030
    0 2890.562160275289900 656.274844704592970
    0 0 1]; %dtu
...
while (~feof(fileID))
    ...
    if ~(data.check_matrix(i,j)==1)
        ...
        try
            [index_final,all_matches, x1, x2, m_e, pose]=asift_pose(path_all, i,j, K1, K2);
            data.m_e(i,j)=m_e;
