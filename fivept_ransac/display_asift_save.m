function [index_final,all_matches, x1, x2, m_e, pose]=display_asift_save(path_all,  ind1,   ind2, K1, K2)
...
[ok, m_e]=remove_points2(pose, f1, f2, match_data.matches_all(:, index_final), K1, K2, image1, image2,1);
...
heat_mapped_matches(image1, image2, K1*cat(1, x1,ones(1, size(x1,2))), K2*cat(1, x2,ones(1, size(x2,2))))
