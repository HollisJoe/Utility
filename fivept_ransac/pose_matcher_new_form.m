function [index_final,all_matches, x1, x2, m_e, pose]=pose_matcher_new_form(path_all,  ind1,   ind2, K1, K2)
thres_spatial=0.01;
% 
...
% K1=[4205.5 0 960; 0 4205.5 640; 0  0 1];
% K2=[4205.5 0 960; 0 4205.5 640; 0  0 1]; %mac
