...
int GlobalParam::		_texMaxDim = 32000;	//Maximum working size for SiftGPU, 3200 for packed
int	GlobalParam::		_texMaxDimGL = 40960;       //GPU texture limit
...
void GlobalUtil::SelectDisplay()
{
	...
	HDC hdc = CreateDC((LPCWSTR)_WindowDisplay, (LPCWSTR)_WindowDisplay, NULL, NULL);
	_WindowDisplay = NULL;
	if(hdc == NULL) 
	{
